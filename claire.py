...
#generate
file = str(open('claire_training_data_4.txt', 'r').read()).split('\n')
#print(file)
...
f = str(open("claire_parts_of_speech.txt", "r").read()).split('\n')
partsOfSpeech = {}
for i in f:
	i = i.split('#')
	if len(i[1]) > 1:
...
weightFile = open("claire_word_pair_weights.txt", 'r').read().split('\n')
...
posWeightFile = open("claire_part_of_speech_weights.txt", 'r').read().split('\n')
...
#open data2
training_data2 = str(open("claire_training_data2.txt", "r").read()).split('\n\n')
...
questions = open("claire_questions.txt", 'r').read().split('\n')
answersFile = open("claire_responses.txt", 'r')
answers = {}
